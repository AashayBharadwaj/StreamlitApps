...
import base64
from data_dict_new import location_metrics  # Import the updated dummy data with images
...
def main():
    ...
    st.image(
        "Location-Scorecard/images/Wide-NFL.png",  # Replace with the path to your image
        use_column_width=True  # Ensures the image spans the full width
    )

    st.markdown(
        "<h1 style='text-align: center;'>Bravas Locations Overview</h2>",
        unsafe_allow_html=True,
    )
